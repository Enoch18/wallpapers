...
<body>
    ...
    <div class = "container" style = "color: white; text-align: justify;">
        ...
        By using DownloadAllWallpapers, you acknowledge and agree to the terms and conditions of this DownloadAllWallpapers Terms of Service Statement 
        ...
        <p>This is necessary in order to protect the user experience of the DownloadAllWallpapers for those who access it in the manner envisioned by its authors.</p>
        ...
        <p>We ask that you respect the above guidelines so that we may continue to offer the DownloadAllWallpapers as a free resource to the world. We prefer 
        ...
        <p>Direct hyperlinking to images and other large files hosted by DownloadAllWallpapers is strictly prohibited without our permission. You may of course 
        ...
        <p>The operators of the web site make a reasonable attempt to maintain the availability and performance of DownloadAllWallpapers and its associated 
        ...
        <p>DownloadAllWallpapers, its owners, employees, contractors, and partners shall not be held legally liable or financially responsible for any loss, damage, 
        or injury incurred as a result of the use or existence of DownloadAllWallpapers, its associated sites, content, services or infrastructure.</p>
