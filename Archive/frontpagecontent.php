                ...
                <form action = "" method = "POST">
                    <?php
                        ...
                        try{
                            ...
                            if($del != '') echo "<input type = 'submit' name = 'delete' value = 'REMOVE' class = 'btn btn-danger'>";
                        }catch(PDOException $e){
                            echo "An error occured. " .$e;
                        }
                    ?>
            ...
            <div class = "col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <form action = "" method = "post" enctype = "multipart/form-data">
                    <?php
                        try{
                            echo "<h5>Add more: </h5>";
                            $sql = "SELECT DISTINCT tagname FROM tagdetails";
                            $result = $pdo->query($sql);
                            while($row = $result->fetch()){
                                echo "
                                    <label class = 'checkbox-inline'>
            ...
            <div class = "col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <form action = "" method = "POST">
                    <?php
                        ...
                        if($del != '') echo "<input type = 'submit' name = 'tagdelete' value = 'REMOVE' class = 'btn btn-danger'>";
                    ?>
                </form>
            </div>
        </div>
