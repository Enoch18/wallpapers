                ...
                <ul class = "list-group">
                    <?php 
                        try{
                            ...
                            $updatetime = '';
                            $catid = '';
                            $sql3 = "SELECT * FROM category WHERE cat_id = '$id' ORDER BY creationdate DESC";
                            $result3 = $pdo->query($sql3);
                            while($row3 = $result3->fetch()){
                               $updatedate = $row3['creationdate'];
                               $updatetime = $row3['creationtime'];
                               $catid = $row3['cat_id'];
                            }
                        ...
                        echo "<br /><h5> 
                                ...
                                Last Category Update: $updatedate $updatetime
                             </h5>
                            ";
                    ?>
                </ul>
